        ...
        if (this.state.quantity <= 1) {
            return (
                <div>
                    <div className="dk-quantityOutterDiv">
                        ...
                        <div >
                            <div className="dk-quantityInnerDiv">
                                <button className="dk-minusButton" onClick={(e) => { this.decreaseQuantity(e) }}>
                                    <span className="dk-minusSpan">
                                        <svg className="dk-minusSvg" style={{
                                            opacity: '.4',
                                        }}><path d="M7,11H17v2H7Z"></path></svg>
                                    </span>
                                </button>
                                <input className="dk-inputField" value={this.state.quantity} onChange={(e) => { this.quantityHandler(e) }} />
                                <button className="dk-plusButton" onClick={(e) => { this.increaseQuantity(e) }}>
                                    <span className="dk-plusSpan">
                                        <svg className="dk-plusSvg" ><path d="M13,11V7H11v4H7v2h4v4h2V13h4V11Z"></path>
                                        </svg>
                                    </span>
                                </button>
                            </div>
                    ...
                    <div className="dk-hiddenMsg" style={{
                        ...
                        <span className="dk-hiddenSpan"><svg viewBox="0 0 16 16">
                            <g >
                ...
                <div className="dk-quantityOutterDiv">
                    ...
                    <div >
                        <div className="dk-quantityInnerDiv">
                            <button className="dk-minusButton" onClick={(e) => { this.decreaseQuantity(e) }}>
                                <span className="dk-minusSpan">
                                    <svg className="dk-minusSvg"><path d="M7,11H17v2H7Z"></path></svg>
                                </span>
                            </button>
                            <input className="dk-inputField" value={this.state.quantity} onChange={(e) => { this.quantityHandler(e) }} />
                            <button className="dk-plusButton" onClick={(e) => { this.increaseQuantity(e) }}>
                    ...
                    <div className="dk-quantityOutterDiv">
                        ...
                        <div >
                            <div className="dk-quantityInnerDiv">
                                ...
                                <button className="dk-plusButton" onClick={(e) => { this.increaseQuantity(e) }}>
                                    <span className="dk-plusSpan">
                                        <svg className="dk-plusSvg" style={{ opacity: '.4' }}><path d="M13,11V7H11v4H7v2h4v4h2V13h4V11Z"></path>
                                        </svg>
                                    </span>
                                </button>
                            </div>
